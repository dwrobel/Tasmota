...
const char HTTP_END[] PROGMEM =
  "<div style='text-align:right;font-size:11px;'><hr/><a href='https://bit.ly/tasmota' target='_blank' style='color:#aaa;'>Tasmota %s (branch: dw-14.6.0.2-development-ds18x20-ext-20250529 rel: 4) %s " D_BY " Theo Arends</a></div>"
  "</div>"
  "</body>"
  "</html>";
