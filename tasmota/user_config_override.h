...
#undef  STA_SSID1
#define STA_SSID1          "NETGEAR-X2"          // [Ssid1] Wifi SSID

#undef  STA_SSID2
#define STA_SSID2          "NETGEAR-X2.1"        // [Ssid2] Optional alternate AP Wifi SSID

// -- Setup your own MQTT settings  ---------------
#undef  MQTT_HOST
#define MQTT_HOST         "piwnica"              // [MqttHost]
